...
class DQNAgent:
    def __init__(self, obs_dim, n_action, seed=0,
                 discount_factor = 0.99, epsilon_decay = 0.999999, epsilon_min = 0.1,
...
agent = DQNAgent(env.observation_space,env.action_space,memory_mode='PER',target_mode='DQN', policy_mode='argmax',
